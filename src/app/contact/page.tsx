...
function ContactForm() {
  ...
  return (
    <div className="pt-20">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <optgroup label="Mechanical Services">
                          <option value="Intake Manifold Cleaning / Walnut Blasting">Intake Manifold Cleaning / Walnut Blasting</option>
                          <option value="Petrol Fuel Injector Cleaning">Petrol Fuel Injector Cleaning</option>
                          <option value="ZF / DCT Transmission Service">ZF / DCT Transmission Service</option>
                          <option value="BMW F1X Headlight Repair">BMW F1X Headlight Repair</option>
                        </optgroup>
                        <optgroup label="Coding & Retrofitting">
                          <option value="Region Change">Region Change</option>
                          <option value="Apple CarPlay Activation">Apple CarPlay Activation</option>
                          <option value="BMW Genuine Reversing Camera">BMW Genuine Reversing Camera</option>
                          <option value="BMW G3X LCI Taillights">BMW G3X LCI Taillights</option>
                          <option value="Speed Limit Info - SLI">Speed Limit Info - SLI</option>
                          <option value="Ambient Lighting F10/F11">Ambient Lighting F10/F11</option>
                          <option value="Other Coding">Other Coding</option>
                        </optgroup>
                        <optgroup label="Performance">
                          <option value="BMW XHP Transmission Remap">BMW XHP Transmission Remap</option>
                          <option value="Performance Remapping">Performance Remapping</option>
                        </optgroup>
      ...
      {/* Location Map */}
      <section id="location" className="py-24 bg-black relative scroll-mt-20">
        {/* Top Glow Effect */}
