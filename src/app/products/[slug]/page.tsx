...
import { ChevronLeft, ChevronRight, Play, Check, ArrowLeft, ShoppingCart, Info, Wrench, Shield } from "lucide-react";
...
export default function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  }, [product.name, selectedOption1, selectedOption2, selectedOption3, selectedOption4, selectedOption5, selectedOption6]);
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="relative bg-zinc-900/50 rounded-xl overflow-hidden mb-4" style={{ aspectRatio: "4/3" }}>
                ...
                {product.video && !showVideo && (
                  <button
                    ...
                    className="absolute bottom-4 right-4 px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:opacity-90 transition-all shadow-lg flex items-center space-x-2"
                  >
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                {product.video && (
                  <button
                    onClick={() => setShowVideo(true)}
                    className={`relative rounded-lg overflow-hidden border-2 transition-all bg-zinc-800 flex items-center justify-center ${
            ...
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">{product.fullDescription || product.description}</p>
              ...
              {product.hasOptions && product.options && (
                <div className="space-y-4 mb-8">
                  ...
                  <div>
                    ...
                    >
                      <option value="">Select...</option>
                      {product.options.dropdown2.choices.map((choice) => (
                        <option key={choice} value={choice}>
                          {choice}
                        </option>
                      ))}
              ...
              >
                ...
                <span>{product.inStock ? "Enquire About This Product" : "Available"}</span>
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {product.installation && (
              <div className="bg-zinc-900/50 border border-white/10 rounded-xl p-8">
                ...
                <p className="text-gray-300">In-House professional installation. Car or Headlights need to be dropped off and left for 1 day. By appointment only</p>
              </div>
            )}
          </div>
        </div>
