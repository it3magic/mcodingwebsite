...
export default function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const productSchema = {
    ...
    "offers": {
      ...
      "priceCurrency": "EUR",
      "price": displayPrice.replace(/[€,]/g, '').split(' ')[0].trim() || product.price.replace(/[€,]/g, '').split(' ')[0].trim(),
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="relative bg-zinc-900/50 rounded-xl overflow-hidden mb-4" style={{ aspectRatio: "4/3" }}>
                ...
                {/* Video Button - TEMPORARILY DISABLED */}
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                {/* Video Thumbnail - TEMPORARILY DISABLED */}
                {/* {product.video && (
                  <button
                    onClick={() => setShowVideo(true)}
            ...
            <div>
              ...
              <div className="text-xl text-gray-300 mb-8 whitespace-pre-line">
